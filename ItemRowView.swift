...
struct ItemRowView: View {
    ...
    // rea;;y important here is the order of observed objects, this is the order
    //which your items are synethised because we are using a struct, project must be first
    @ObservedObject var project: Project
    @ObservedObject var item: Item
    //create a computed property to calculate which icon to use, makes items more clear on what
    //stage they are at
